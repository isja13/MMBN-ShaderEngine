...
// Custom display resolution 95% wired up, but not exposed.
// Custom render resolution separate from display broken
...
#include <C:\Program Files (x86)\Windows Kits\10\Include\10.0.26100.0\um\d3d11.h>  // dedicated path over relative for RetroArch conflict avoidance
#include <dinput.h>
...
#define MOD_NAME "ShaderEngine"
#define LOG_FILE_NAME _T("shader-engine.log")
#define INI_FILE_NAME _T("shader-engine.ini")
