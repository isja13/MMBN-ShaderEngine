...
static LONG WINAPI CrashHandler(EXCEPTION_POINTERS* ep) {
    ...
    // Optional: ignore breakpoint exceptions
...
BOOL WINAPI DllMain(
    ...
    switch( fdwReason )
    {
        ...
        {
			AddVectoredExceptionHandler(1, CrashHandler); //intellisense doesn't like this for some reason
        ...
        // Any thread-specific initialization.
            break;

        case DLL_THREAD_DETACH:
        // Any thread-specific cleanup.
            break;
...
bool cs_wrapper::try_begin_cs() {
	return TryEnterCriticalSection(&impl->cs); //intellisense doesn't like this for some reason
}
