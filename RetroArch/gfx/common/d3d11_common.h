...
typedef void* ID3D11SwitchToRef;
#endif
typedef ID3D11SwitchToRef* D3D11SwitchToRef;

#ifdef __ID3D11TracingDevice_INTERFACE_DEFINED__
typedef ID3D11TracingDevice* D3D11TracingDevice;
#else
typedef void* D3D11TracingDevice;
#endif
...
#ifndef APP_DEPRECATED_HRESULT
#define APP_DEPRECATED_HRESULT HRESULT
#endif
...
{
   return info_queue->lpVtbl->GetMessage(info_queue, message_index, message, message_byte_length);
}
#endif
